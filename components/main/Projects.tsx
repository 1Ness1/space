  ...
  return (
    <div className="flex flex-col items-center justify-center py-20">
      ...
      <div className="h-full w-full flex flex-col md:flex-row gap-10 px-10">
        <ProjectCard src="/NextWebsite.png" title="Modern Next.js Portfolio" description="Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum" />
        <ProjectCard src="/CardImage.png" title="Modern Next.js Portfolio" description="Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum" />
